...
public class Money implements Comparable {
	...
	public String toString() {
		String result = getAmount() + " " + this.currency.getName();
		return result;
	}
	...
	public Money add(Money other) {
		int otherAmountInThisValue = this.currency.valueInThisCurrency(other.amount, other.currency);
		int newAmount = this.amount + otherAmountInThisValue;
	...
	public int compareTo(Object other) {
		...
		return Integer.compare(universalValue(), otherMoney.universalValue());
	}
}